...
class SiteCreate extends StatefulWidget {
  SiteCreate({
    required this.id,
  ...
  @override
  State<SiteCreate> createState() => _SiteCreateState();
}

class _SiteCreateState extends State<SiteCreate> {
  ...
  void showMsgDialog(BuildContext context, String errorMsg) {
    showDialog(
      context: context,
  ...
  Future CreateClient() async {
    ...
    try {
      var response = await Dio().post(BASE_API2 + 'site/register-client',
          data: {
      ...
      if (response.data["status"] == true && response.data["message"] == "Site and schedule Added Successfully") {
        print("Create User Successfully");
        showMsgDialog(context, "Create Client Successfully");
      ...
      if(e.response?.statusCode == 400){
        ...
        showMsgDialog(context, e.response?.data["message"]);
