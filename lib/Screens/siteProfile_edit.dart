...
class SiteProfileEdit extends StatefulWidget {
  SiteProfileEdit({
  ...
  String? type;
  @override
  State<SiteProfileEdit> createState() => _SiteProfileEditState();
}
class _SiteProfileEditState extends State<SiteProfileEdit> {
